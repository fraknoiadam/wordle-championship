...
export const embeddingsList: EmbeddingItem[] = [
  ...
  },
  {
    ...
    text: "Itt pedig egy 3 betűset, de csak 3 tipped van. A narancssárga szín jelzi, hogy egy betű szerepel a megoldásban, csak rossz helyen, a kék pedig azt, ha jó helyen is van.",
    color: "#ffff00",
    title: "Thirdle"
  },
  {
  ...
  },
  {
    ...
    text: "Olyan, mint a Szó reggelt!, de itt a több karakterből álló betűk csak egy helyet foglalnak csak el.",
    color: "#ffff00",
    title: "Szózat"
  },
  {
  ...
  },
  {
    ...
    text: "Ez pedig 6-tal… A játék megnyitása után kattints a \"free hexordle\" gombra!",
    color: "#ffff00",
    title: "Hexordle"
  },
  {
    link: "https://sixordle.com/practice",
    text: "30. pálya! Ennek örömére ismét 6 szót kell kitalálnod párhuzamosan, de ezek 6 betűsek.",
    color: "#ffff00",
    title: "Sixordle"
  },
  {
